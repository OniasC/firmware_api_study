...
*/
PURE static inline matrix_data_t matrix_get(const matrix_t *const mat, const register uint_fast8_t row, const register uint_fast8_t column)
{
...
void matrix_set_ONIAS(matrix_t *mat, const register uint_fast8_t row, const register uint_fast8_t column, const register matrix_data_t value);
...
* \param[in] value The value to set
*/
static inline void matrix_set_symmetric(matrix_t *mat, const register uint_fast8_t row, const register uint_fast8_t column, const register matrix_data_t value)
{
    matrix_set_ONIAS(mat, row, column, value);
    matrix_set_ONIAS(mat, column, row, value);
}
...
*/
static inline void matrix_get_row_pointer(const matrix_t *const mat, const register uint_fast8_t row, matrix_data_t **row_data)
{
...
*/
HOT static inline void matrix_get_column_copy(const matrix_t *const mat, const register uint_fast8_t column, register matrix_data_t *const row_data)
{
...
*/
inline void matrix_get_row_copy(const matrix_t *const mat, const register uint_fast8_t row, register matrix_data_t *const row_data)
{
...
*/
static inline void matrix_copy(const matrix_t *const mat, matrix_t *const target)
{
...
*/
HOT static inline void matrix_sub(const matrix_t *const a, matrix_t *const b, const matrix_t *c)
{
...
void matrix_sub_inplace_b_ONIAS(const matrix_t *RESTRICT const a, const matrix_t *RESTRICT b);
...
void matrix_add_inplace_ONIAS(const matrix_t * a, const matrix_t *const b);
