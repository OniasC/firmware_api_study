...
* \see kalman_predict_Q
*/
static inline void kalman_predict(kalman_t *kf)
{
    /************************************************************************/
	...
	//TODO: add the x = Ax [[ + Bu ]]
	//B*u is what adds the previous input to aid predicting the next stage
    kalman_predict_x(kf);
...
* \see kalman_predict_Q_tuned
*/
HOT static inline void kalman_predict_tuned(kalman_t *kf, matrix_data_t lambda)
{
    /************************************************************************/
    /* Predict next state using system dynamics                             */
    /* x = A*x                                                              */
...
*/
HOT PURE static inline matrix_t* kalman_get_state_vector(kalman_t *kf)
{
    return &(kf->x);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_state_transition(kalman_t *kf)
{
    return &(kf->A);
}
...
*/
PURE static inline matrix_t* kalman_get_system_covariance(kalman_t *kf)
{
    return &(kf->P);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_input_vector(kalman_t *kf)
{
    return &(kf->u);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_input_transition(kalman_t *kf)
{
    return &(kf->B);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_input_covariance(kalman_t *kf)
{
    return &(kf->Q);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_measurement_vector(kalman_measurement_t *kfm)
{
    return &(kfm->z);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_measurement_transformation(kalman_measurement_t *kfm)
{
    return &(kfm->H);
}
...
*/
HOT PURE static inline matrix_t* kalman_get_process_noise(kalman_measurement_t *kfm)
{
    return &(kfm->R);
}
