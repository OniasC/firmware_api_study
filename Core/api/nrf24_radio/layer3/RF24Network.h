...
#include "../../nrf24_radio/layer3/RF24Network_config.h"
...
typedef struct
{
	...
	uint8_t frame_size;
	unsigned int max_frame_payload_size;// = MAX_FRAME_SIZE - sizeof(RF24NetworkHeader);
...
bool RF24Network_write_2_params(RF24Network_t * const rf24network, uint16_t to_node, uint8_t directTo);
