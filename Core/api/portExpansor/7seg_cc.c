...
display_7seg_status display_7seg_cc_ctor(display_7seg_cc_t * const me, display_7seg_status status)
{
	static const struct display_7seg_vtable vtable = {
		(display_7seg_status (*)(	display_7seg_t * const me,
									display_7seg_digit_e number,
									display_7seg_dot_e dot))&display_7seg_cc_writeDigitVTable,
	};
	display_7seg_status display_7seg_ctor_status = display_7seg_ctor(&(me->super));
...
{
	display_7seg_cc_ZeroVTable(me, disp_7Seg_off);
	for (int i = 0; i < 8U; i++)
	{
